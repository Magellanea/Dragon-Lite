...
class AdminView(ModelView):
    ...
    def __init__(self, model, session, name=None, category=None, endpoint=None, url=None, static_folder=None, menu_class_name=None, menu_icon_type=None, menu_icon_value=None, columns=None, validations=None):
        if columns is not None:
            self.column_list = columns
        if validations is not None:
            self.form_args = validations
